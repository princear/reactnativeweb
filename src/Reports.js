    ...
    return (
        ...
        <View style={Platform.OS == 'web' ? styles.webView : styles.container}>
            ...
            <View style={{alignItems:'center', marginTop:hp(17)}}>
                <Image source={require('../src/assets/icons/Group26086782.png')}  style={styles.imageCenter}/>
                <View style={{marginTop:hp(7),alignItems:'center',}}>
                <Text style={styles.headingText}>Unlock Vital Biomarkers!</Text>
                <Text style={styles.subheadingText}>There are no record of your reports here.
                    Upload your lab reports to get health insights.</Text>
