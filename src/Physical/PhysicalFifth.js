...
const PhysicalFifth  = ({ navigation }) => {
        ...
        <View style={Platform.OS === 'web' ? styles.webView : styles.containerWrapper}>
            ...
            <View style={{ marginLeft: 10 }}>
                ...
                <View style={{ alignItems: 'center', marginTop: hp(5)}}>
                        <Image source={require('../assets/icons/Group26086738.png')} style={styles.headingCenterImage} />
                    </View>
                    <View style={{ marginTop: hp(12) }}>
                        <QuestionText children='Are you facing/ have experienced significant hair loss? (more than 50%)' />
                    </View>
