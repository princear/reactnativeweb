...
const PhysicalTwentyFive  = ({ navigation }) => {
            ...
            <View style={{ marginLeft: 10 }}>
                ...
                <View style={{marginTop:hp(13)}}>
                    ...
                    <View style={{ marginTop: hp(12) }}>
                        <QuestionText children='Do you have copper colored nails?' />
                    </View>
                    <View style={{ alignItems: 'center', marginTop: hp(3)}}>
                        <Image source={require('../assets/icons/image1145.png')} style={styles.headingCenterImage} />
                    </View>
...
export default PhysicalTwentyFive;