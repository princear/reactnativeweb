        ...
        <View style={Platform.OS === 'web' ? styles.webView : styles.containerWrapper}>
            ...
            <View style={{ marginLeft: 10 }}>
                <View style={styles.headingWrapper}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('PrakiriFifteenTest')}>
                ...
                <View style={{ alignItems: 'center', marginTop: '10%' }}>
                    ...
                    <Image source={require('../src/assets/icons/cuate.png')} style={styles.headingCenterImage} />
                    </View>
                    <View style={{ marginTop: 15, marginRight: 10, }}>
                        <Text style={styles.levelHeading}>You're going through tough times, and a friend offers support if you open up. Would you share your feelings with them?</Text>
