        ...
        <View style={Platform.OS === 'web' ? styles.webView : styles.containerWrapper}>
            ...
            <View style={{ marginLeft: 10 }}>
                <View style={styles.headingWrapper}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('PrakiriSixteenTest')}>
                ...
                <View style={{ alignItems: 'center', marginTop: '10%' }}>
                    ...
                    <Image source={require('../src/assets/icons/image139.png')} style={styles.headingCenterImage} />
                    </View>
                    <View style={{ marginTop: 15, marginRight: 10, }}>
                        <Text style={styles.levelHeading}>You're at a party where you know only a few people. How likely are you to approach and talk to new people?</Text>
