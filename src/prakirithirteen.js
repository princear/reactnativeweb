        ...
        <View style={Platform.OS === 'web' ? styles.webView : styles.containerWrapper}>
            ...
            <View style={{ marginLeft: 10 }}>
                <View style={styles.headingWrapper}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('PrakiriFourteenTest')}>
                ...
                <View style={{ alignItems: 'center', marginTop: '10%' }}>
                    ...
                    <Image source={require('../src/assets/icons/image138.png')} style={styles.headingCenterImage} />
                    </View>
                    <View style={{ marginTop: 15, marginRight: 10, }}>
                        <Text style={styles.levelHeading}>Your friends suggest bungee jumping, but you're afraid of heights. Would you join them?</Text>
