        ...
        <View style={Platform.OS === 'web' ? styles.webView : styles.containerWrapper}>
            ...
            <View style={{ marginLeft: 10 }}>
                ...
                <View style={{ alignItems: 'center', marginTop: '10%' }}>
                    ...
                    <Image source={require('../src/assets/icons/Group26086710.png')} style={styles.headingCenterImage} />
                    </View>
                    <View style={{ marginTop: 15, marginRight: 10, }}>
                        <Text style={styles.levelHeading}>Your co-worker is unfairly blamed for someone else's mistake. Speaking up might put you in an awkward position. Would you support and clarify the situation?</Text>
